...
2. **Load the skill body** — read `{{PLATFORM_DIR}}/skills/osx-review-artifacts/SKILL.md` and follow `## Workflow`. This command wraps that skill; do not duplicate rules here.
