...
> Source: https://github.com/Fission-AI/OpenSpec/blob/master/docs/cli.md
...
- [Commands](openspec-commands.md) - AI slash commands (`/opsx:new`, `/opsx:apply`, etc.)
- [Workflows](openspec-workflows.md) - Common patterns and when to use each command
- [Concepts](openspec-concepts.md) - Core philosophy, specs, changes, delta specs
