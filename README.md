...
[![Version](https://img.shields.io/badge/version-v1.11.1-orange.svg?style=flat-square)](CHANGELOG.md)
...
```bash
# Specific version
VERSION=v1.11.1 curl -sSL https://raw.githubusercontent.com/amauryconstant/openspec-extended/main/install.sh | bash
```
