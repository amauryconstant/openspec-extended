...
[![Version](https://img.shields.io/badge/version-v1.4.0-orange.svg?style=flat-square)](https://github.com/amauryconstant/openspec-extended)
...
```bash
VERSION=v1.4.0 curl -sSL https://raw.githubusercontent.com/amauryconstant/openspec-extended/main/install.sh | bash
```
