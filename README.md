...
[![Version](https://img.shields.io/badge/version-v1.10.4-orange.svg?style=flat-square)](https://github.com/amauryconstant/openspec-extended)
...
```bash
# Specific version
VERSION=v1.10.4 curl -sSL https://raw.githubusercontent.com/amauryconstant/openspec-extended/main/install.sh | bash
```
