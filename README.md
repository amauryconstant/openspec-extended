...
[![Version](https://img.shields.io/badge/version-v1.11.0-orange.svg?style=flat-square)](CHANGELOG.md)
...
```bash
# Specific version
VERSION=v1.11.0 curl -sSL https://raw.githubusercontent.com/amauryconstant/openspec-extended/main/install.sh | bash
```
